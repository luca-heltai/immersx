...
| `fiber_reinforced_elastodynamics` | `apps/app_fiber_reinforced_elastodynamics.cc`; matrix and fiber `Elastodynamics` Problems | `2/2`, `3/3` | Full-order distributed coupling, backward Euler and Schur solve; MPI | `tutorials/fiber_reinforced_elastodynamics/parameters.prm.in`; advanced tutorial |
| `navier_stokes` | `apps/app_navier_stokes.cc`; `NavierStokesSolver` | `2/2`, `3/3` | Standalone transient mixed velocity-pressure solve; MPI | `tutorials/navier_stokes/transient_2d.prm.in`; independent tutorial |
