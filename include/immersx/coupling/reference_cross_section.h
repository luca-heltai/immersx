...
namespace ImmersX
{
  ...
  public:
    ...
    /// Compute the cross section measure for the inclusion. The returned value
    /// is exact w.r.t. to the used quadrature formula, i.e., it is the integral
    /// of one on the cross section. If a scale is provided, the measure is
