...
namespace ImmersX
{
   ...
   * `solve()`, `output_results()`, and optional `refine_grid()` are
   * orchestrated by `run()`. It owns one scalar finite-element space, one
   * assembled stiffness matrix, and one distributed solution vector.
   *
