 ...
 *
 * The default finite-element pair is Taylor--Hood Q_k/Q_{k-1}. The pressure is
 * normalized by constraining one pressure degree of freedom to zero. This is a
 * direct algebraic pressure normalization; it removes the constant nullspace
 * without adding a third Lagrange-multiplier block.
 *
